...
<div class="bg-gradient-primary py-5">
  <div class="container text-center text-light">
    ...
    <a href="mailto:Vieryandrean00@gmail.com" class="btn btn-light mr-1">Chat admin</a>
    <a href="mailto:Vieryandrean00@gmail.com" class="btn btn-outline-light ml-1">Contact Developer</a>
  </div>
</div>
...
<div class="bg-gray-400 py-3">
  <footer>
    <div class="text-center mt-2 text-gray-700">
      <h6>Copyright &copy;2025 - Andrean Viery.</h6>
    </div>
  </footer>
</div>
